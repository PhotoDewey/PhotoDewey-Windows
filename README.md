...
Grab the latest Windows installer from the [Releases page](https://github.com/PhotoDewey/PhotoDewey-Windows/releases/latest):

➡ **[Download Setup.exe](https://github.com/PhotoDewey/PhotoDewey-Windows/releases/latest/PhotoDewey-stable-Setup.exe)**
...
Browse the [Issues tab](https://github.com/PhotoDewey/PhotoDewey-Windows/issues) first to see if your idea is already there. If it is, **add a 👍 reaction** to upvote it — popular requests move up the backlog.

If it isn't, open a [new issue](https://github.com/PhotoDewey/PhotoDewey-Windows/issues/new/choose) using the **Feature request** template. Tell us:
